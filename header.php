...
@media(max-width:900px){.header-search{position:static;transform:none;width:min(360px,100%);margin:0 auto 10px}.header-top-row{flex-wrap:wrap;min-height:0}.header-top-row .brand{order:1}.header-contact{order:2}.header-search{order:3;flex-basis:100%}.search-result-image{width:170px;min-width:170px}}@media(max-width:650px){.header-contact{font-size:11px}.search-result-card{display:block}.search-result-image{width:100%;min-width:0;height:170px}.search-result-image img{height:170px;min-height:0}.search-result-content{padding:15px}.search-page-row{flex-direction:column}.search-page-row .btn{width:100%}}
</style></head>
